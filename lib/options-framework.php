...
function add_theme_menu_item() {
    add_menu_page("Material Options", "Material Options", "manage_options", "theme-panel", "theme_settings_page", null, 99);
}
...
?>
    ...
    <form method="post" action="options.php" class="form form-control">
        <?php
...
?>
        <input type="text" name="facebook_url" id="facebook_url" value="<?php
